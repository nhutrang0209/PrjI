...
public class ChangPassView extends javax.swing.JFrame {
    ...
    public ChangPassView(String email) {
        this.email=email;
        initComponents();
        setSize(600,500);
    }
    ...
    private void btnUpdatePassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdatePassActionPerformed
       //Thay doi mk tren CSDL
        ...
        try {
            String sql = "SELECT MK FROM docgia WHERE EMAIL=?";
            ...
            if (txtOldPass.getText().equals("") ) {
                ...
                if(txtOldPass.getText().equals(pass)){
                    ...
                    if(newPass.length()<1){
                        ...
                        if(!newPass.equals(confirmNewPass)){
                            ...
                            String sqlChangePass = "UPDATE docgia SET MK=? WHERE EMAIL=?";
                ...
                else JOptionPane.showMessageDialog(this,"Mật khẩu cũ chưa chính xác");                
                //In thong bao ngay duoi o mk cu(Them sau)
            } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangPassView("trang2002cool@gmail.").setVisible(true);
            }
        });
    }
