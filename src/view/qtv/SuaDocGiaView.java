...
//    private DocGiaModel docGiaModel;
    ...
    private void initTable() {
        ...
        tblModel.setColumnIdentifiers(new String[]{"ID", "Tên độc giả", "Số điện thoại", "Email", "Ngày sinh", "CCCD"});
        ...
        tbldg.getColumnModel().getColumn(5).setPreferredWidth(110);
    ...
    rowSelectionModel.addListSelectionListener(new ListSelectionListener() {
      public void valueChanged(ListSelectionEvent e) {
        ...
        selectedMadg=(int)tbldg.getValueAt(selectedRow[0], 0);
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnChange, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 390, 130, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 700, 210));
    ...
    private void tbldgMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbldgMouseClicked
        try {
            ...
            if (row >= 0) {
                int madg = (int) tbldg.getValueAt(row, 0);
                DocGiaDao dao = new DocGiaDao();
                DocGiaModel dg = dao.findById(madg);
                if (dg != null) {
